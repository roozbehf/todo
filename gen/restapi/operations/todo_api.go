...
func NewTodoAPI(spec *loads.Document) *TodoAPI {
	return &TodoAPI{
		...
		ListItemsHandler: ListItemsHandlerFunc(func(params ListItemsParams) middleware.Responder {
			return middleware.NotImplemented("operation ListItems has not yet been implemented")
		}),
		RemoveItemHandler: RemoveItemHandlerFunc(func(params RemoveItemParams) middleware.Responder {
			return middleware.NotImplemented("operation RemoveItem has not yet been implemented")
		}),
	}
}
...
func (o *TodoAPI) Validate() error {
	...
	if o.ListItemsHandler == nil {
		unregistered = append(unregistered, "ListItemsHandler")
	}

	if o.RemoveItemHandler == nil {
		unregistered = append(unregistered, "RemoveItemHandler")
	}
...
func (o *TodoAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/add/{itemTitle}"] = NewAddItem(o.context, o.AddItemHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/list"] = NewListItems(o.context, o.ListItemsHandler)

	if o.handlers["DELETE"] == nil {
		o.handlers["DELETE"] = make(map[string]http.Handler)
	}
	o.handlers["DELETE"]["/remove/{id}"] = NewRemoveItem(o.context, o.RemoveItemHandler)
